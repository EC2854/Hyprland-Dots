...
local mappings = {
    ["/"] = { "<cmd>lua require'telescope.builtin'.find_files(require('telescope.themes').get_dropdown({ previewer = true }))<CR>", "Comment" },
    ["w"] = { "<cmd>w!<CR>", "Save" },
    ["q"] = { "<cmd>q!<CR>", "Quit" },
    ...
    t = {
        ...
        r = { "<cmd>ColorizerToggle <CR>", "Toggle Rainbow Mode" },
